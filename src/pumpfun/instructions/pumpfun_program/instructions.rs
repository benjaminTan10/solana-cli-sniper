...
pub fn initialize_ix(keys: InitializeKeys) -> std::io::Result<Instruction> {
    initialize_ix_with_program_id(PUMP_PROGRAM, keys)
}
...
pub fn initialize_invoke(accounts: InitializeAccounts<'_, '_>) -> ProgramResult {
    initialize_invoke_with_program_id(PUMP_PROGRAM, accounts)
}
...
pub fn initialize_invoke_signed(
    ...
    initialize_invoke_signed_with_program_id(PUMP_PROGRAM, accounts, seeds)
}
...
pub fn set_params_ix(keys: SetParamsKeys, args: SetParamsIxArgs) -> std::io::Result<Instruction> {
    set_params_ix_with_program_id(PUMP_PROGRAM, keys, args)
}
...
pub fn set_params_invoke(
    ...
    set_params_invoke_with_program_id(PUMP_PROGRAM, accounts, args)
}
...
pub fn set_params_invoke_signed(
    ...
    set_params_invoke_signed_with_program_id(PUMP_PROGRAM, accounts, args, seeds)
}
...
pub fn create_ix(keys: CreateKeys, args: CreateIxArgs) -> std::io::Result<Instruction> {
    create_ix_with_program_id(PUMP_PROGRAM, keys, args)
}
...
pub fn create_invoke(accounts: CreateAccounts<'_, '_>, args: CreateIxArgs) -> ProgramResult {
    create_invoke_with_program_id(PUMP_PROGRAM, accounts, args)
}
...
pub fn create_invoke_signed(
    ...
    create_invoke_signed_with_program_id(PUMP_PROGRAM, accounts, args, seeds)
}
...
pub fn buy_ix(keys: BuyKeys, args: BuyIxArgs) -> std::io::Result<Instruction> {
    buy_ix_with_program_id(PUMP_PROGRAM, keys, args)
}
...
pub fn buy_invoke(accounts: BuyAccounts<'_, '_>, args: BuyIxArgs) -> ProgramResult {
    buy_invoke_with_program_id(PUMP_PROGRAM, accounts, args)
}
...
pub fn buy_invoke_signed(
    ...
    buy_invoke_signed_with_program_id(PUMP_PROGRAM, accounts, args, seeds)
}
...
pub fn sell_ix(keys: SellKeys, args: SellIxArgs) -> std::io::Result<Instruction> {
    sell_ix_with_program_id(PUMP_PROGRAM, keys, args)
}
...
pub fn sell_invoke(accounts: SellAccounts<'_, '_>, args: SellIxArgs) -> ProgramResult {
    sell_invoke_with_program_id(PUMP_PROGRAM, accounts, args)
}
...
pub fn sell_invoke_signed(
    ...
    sell_invoke_signed_with_program_id(PUMP_PROGRAM, accounts, args, seeds)
}
...
pub fn withdraw_ix(keys: WithdrawKeys) -> std::io::Result<Instruction> {
    withdraw_ix_with_program_id(PUMP_PROGRAM, keys)
}
...
pub fn withdraw_invoke(accounts: WithdrawAccounts<'_, '_>) -> ProgramResult {
    withdraw_invoke_with_program_id(PUMP_PROGRAM, accounts)
}
...
pub fn withdraw_invoke_signed(
    ...
    withdraw_invoke_signed_with_program_id(PUMP_PROGRAM, accounts, seeds)
}
