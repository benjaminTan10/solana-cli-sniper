...
// pub async fn single_pool(server_data: JitoPoolData) -> eyre::Result<PoolDeployResponse> {
//     let connection = {
//         let http_client = HTTP_CLIENT.lock().unwrap();
//         http_client.get("http_client").unwrap().clone()
//     };

//     let deployer_key = Keypair::from_base58_string(&server_data.deployerPrivateKey);
//     let buyer_key = Keypair::from_base58_string(&server_data.buyerPrivateKey);

//     let buy_amount = sol_to_lamports((server_data.tokenbuyAmount.parse::<f64>())?);
...
//     let jito_txn = tip_txn(
//         buyer_key.pubkey(),
//         tip_account(),
//         sol_to_lamports(server_data.BundleTip.parse::<f64>().unwrap()),
//     );
