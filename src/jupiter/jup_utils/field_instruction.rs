...
pub mod option_instruction {
        ...
        D: Deserializer<'de>,
    {
        ...
        match value {
            ...
            _ => crate::jupiter::jup_utils::field_instruction::instruction::deserialize(value)
                .map_err(|e| {
...
pub mod vec_instruction {
        ...
        D: Deserializer<'de>,
    {
        ...
        for value in values {
            let instruction: Instruction =
                crate::jupiter::jup_utils::field_instruction::instruction::deserialize(value)
                    .map_err(|e| {
                        serde::de::Error::custom(format!(
                            "Error deserialize vec instruction: {}",
                            e
                        ))
                    })?;
