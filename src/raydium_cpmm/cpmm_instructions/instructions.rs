...
impl RaydiumCpSwapProgramIx {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        ...
        match maybe_discm {
            CREATE_AMM_CONFIG_IX_DISCM => Ok(Self::CreateAmmConfig(
                CreateAmmConfigIxArgs::deserialize(&mut reader)?,
            )),
            UPDATE_AMM_CONFIG_IX_DISCM => Ok(Self::UpdateAmmConfig(
                UpdateAmmConfigIxArgs::deserialize(&mut reader)?,
            )),
            UPDATE_POOL_STATUS_IX_DISCM => Ok(Self::UpdatePoolStatus(
                UpdatePoolStatusIxArgs::deserialize(&mut reader)?,
            )),
            COLLECT_PROTOCOL_FEE_IX_DISCM => Ok(Self::CollectProtocolFee(
                CollectProtocolFeeIxArgs::deserialize(&mut reader)?,
            )),
            COLLECT_FUND_FEE_IX_DISCM => Ok(Self::CollectFundFee(
                CollectFundFeeIxArgs::deserialize(&mut reader)?,
            )),
            ...
            SWAP_BASE_INPUT_IX_DISCM => Ok(Self::SwapBaseInput(SwapBaseInputIxArgs::deserialize(
                &mut reader,
            )?)),
            SWAP_BASE_OUTPUT_IX_DISCM => Ok(Self::SwapBaseOutput(
                SwapBaseOutputIxArgs::deserialize(&mut reader)?,
            )),
...
pub fn create_amm_config_ix(
    ...
    create_amm_config_ix_with_program_id(RAYDIUM_CPMM, keys, args)
}
...
pub fn create_amm_config_invoke(
    ...
    create_amm_config_invoke_with_program_id(RAYDIUM_CPMM, accounts, args)
}
...
pub fn create_amm_config_invoke_signed(
    ...
    create_amm_config_invoke_signed_with_program_id(RAYDIUM_CPMM, accounts, args, seeds)
}
...
pub fn update_amm_config_ix(
    ...
    update_amm_config_ix_with_program_id(RAYDIUM_CPMM, keys, args)
}
...
pub fn update_amm_config_invoke(
    ...
    update_amm_config_invoke_with_program_id(RAYDIUM_CPMM, accounts, args)
}
...
pub fn update_amm_config_invoke_signed(
    ...
    update_amm_config_invoke_signed_with_program_id(RAYDIUM_CPMM, accounts, args, seeds)
}
...
pub fn update_pool_status_ix(
    ...
    update_pool_status_ix_with_program_id(RAYDIUM_CPMM, keys, args)
}
...
pub fn update_pool_status_invoke(
    ...
    update_pool_status_invoke_with_program_id(RAYDIUM_CPMM, accounts, args)
}
...
pub fn update_pool_status_invoke_signed(
    ...
    update_pool_status_invoke_signed_with_program_id(RAYDIUM_CPMM, accounts, args, seeds)
}
...
pub fn collect_protocol_fee_ix(
    ...
    collect_protocol_fee_ix_with_program_id(RAYDIUM_CPMM, keys, args)
}
...
pub fn collect_protocol_fee_invoke(
    ...
    collect_protocol_fee_invoke_with_program_id(RAYDIUM_CPMM, accounts, args)
}
...
pub fn collect_protocol_fee_invoke_signed(
    ...
    collect_protocol_fee_invoke_signed_with_program_id(RAYDIUM_CPMM, accounts, args, seeds)
}
pub fn collect_protocol_fee_verify_account_keys(
    ...
    for (actual, expected) in [
        ...
        (
            *accounts.recipient_token0_account.key,
            keys.recipient_token0_account,
        ),
        (
            *accounts.recipient_token1_account.key,
            keys.recipient_token1_account,
        ),
...
pub fn collect_fund_fee_ix(
    ...
    collect_fund_fee_ix_with_program_id(RAYDIUM_CPMM, keys, args)
}
...
pub fn collect_fund_fee_invoke(
    ...
    collect_fund_fee_invoke_with_program_id(RAYDIUM_CPMM, accounts, args)
}
...
pub fn collect_fund_fee_invoke_signed(
    ...
    collect_fund_fee_invoke_signed_with_program_id(RAYDIUM_CPMM, accounts, args, seeds)
}
...
pub fn initialize_ix(keys: InitializeKeys, args: InitializeIxArgs) -> std::io::Result<Instruction> {
    initialize_ix_with_program_id(RAYDIUM_CPMM, keys, args)
}
...
pub fn initialize_invoke(
    ...
    initialize_invoke_with_program_id(RAYDIUM_CPMM, accounts, args)
}
...
pub fn initialize_invoke_signed(
    ...
    initialize_invoke_signed_with_program_id(RAYDIUM_CPMM, accounts, args, seeds)
}
...
pub fn deposit_ix(keys: DepositKeys, args: DepositIxArgs) -> std::io::Result<Instruction> {
    deposit_ix_with_program_id(RAYDIUM_CPMM, keys, args)
}
...
pub fn deposit_invoke(accounts: DepositAccounts<'_, '_>, args: DepositIxArgs) -> ProgramResult {
    deposit_invoke_with_program_id(RAYDIUM_CPMM, accounts, args)
}
...
pub fn deposit_invoke_signed(
    ...
    deposit_invoke_signed_with_program_id(RAYDIUM_CPMM, accounts, args, seeds)
}
...
pub fn withdraw_ix(keys: WithdrawKeys, args: WithdrawIxArgs) -> std::io::Result<Instruction> {
    withdraw_ix_with_program_id(RAYDIUM_CPMM, keys, args)
}
...
pub fn withdraw_invoke(accounts: WithdrawAccounts<'_, '_>, args: WithdrawIxArgs) -> ProgramResult {
    withdraw_invoke_with_program_id(RAYDIUM_CPMM, accounts, args)
}
...
pub fn withdraw_invoke_signed(
    ...
    withdraw_invoke_signed_with_program_id(RAYDIUM_CPMM, accounts, args, seeds)
}
...
pub fn swap_base_input_ix(
    ...
    swap_base_input_ix_with_program_id(RAYDIUM_CPMM, keys, args)
}
...
pub fn swap_base_input_invoke(
    ...
    swap_base_input_invoke_with_program_id(RAYDIUM_CPMM, accounts, args)
}
...
pub fn swap_base_input_invoke_signed(
    ...
    swap_base_input_invoke_signed_with_program_id(RAYDIUM_CPMM, accounts, args, seeds)
}
...
pub fn swap_base_output_ix(
    ...
    swap_base_output_ix_with_program_id(RAYDIUM_CPMM, keys, args)
}
...
pub fn swap_base_output_invoke(
    ...
    swap_base_output_invoke_with_program_id(RAYDIUM_CPMM, accounts, args)
}
...
pub fn swap_base_output_invoke_signed(
    ...
    swap_base_output_invoke_signed_with_program_id(RAYDIUM_CPMM, accounts, args, seeds)
}
