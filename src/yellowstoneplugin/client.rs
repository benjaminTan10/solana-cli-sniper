...
impl Default for ArgsCommitment {
    fn default() -> Self {
        ArgsCommitment::Processed // or whatever default value you want
    }
}
...
struct ActionSubscribe {
    ...
    pub accounts_account: Vec<String>,

    /// Filter by Owner Pubkey
    pub accounts_owner: Vec<String>,

    /// Filter by Offset and Data, format: `offset,data in base58`
    pub accounts_memcmp: Vec<String>,

    /// Filter by Data size
    pub accounts_datasize: Option<u64>,

    /// Filter valid token accounts
    pub accounts_token_account_state: bool,

    /// Receive only part of updated data account, format: `offset,size`
    pub accounts_data_slice: Vec<String>,

    /// Subscribe on slots updates
    pub slots: bool,

    /// Filter slots by commitment
    pub slots_filter_by_commitment: bool,

    /// Subscribe on transactions updates
    pub transactions: bool,

    /// Filter vote transactions
    pub transactions_vote: Option<bool>,

    /// Filter failed transactions
    pub transactions_failed: Option<bool>,

    /// Filter by transaction signature
    pub transactions_signature: Option<String>,

    /// Filter included account in transactions
    pub transactions_account_include: Vec<String>,

    /// Filter excluded account in transactions
    pub transactions_account_exclude: Vec<String>,

    /// Filter required account in transactions
    pub transactions_account_required: Vec<String>,

    /// Subscribe on entry updates
    pub entry: bool,

    /// Subscribe on block updates
    pub blocks: bool,

    /// Filter included account in blocks
    pub blocks_account_include: Vec<String>,
    ...
    /// Resubscribe (only to slots) after a certain number of updates
    pub resub: Option<usize>,
}
